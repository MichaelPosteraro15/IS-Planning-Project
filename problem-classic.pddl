(define (problem adam)
  ...
  (:init
    ...
    ;; ---------- neve nelle celle --------------------------------------
    ;; Celle con neve (corrispondono a location_type = 1 nell'esempio numerico)
    (snow loc_1_1)
    (snow loc_1_2)
    (snow loc_1_3)
    (snow loc_1_4)
    ...
    ;; ---------- palle ---------------------------------------------------
    ;; Tutte le palle iniziano piccole (small)
    (ball_at ball_0 loc_2_3)   (ball_size_small ball_0)
    (ball_at ball_1 loc_3_3)   (ball_size_small ball_1)
    (ball_at ball_2 loc_4_3)   (ball_size_small ball_2)

    ;; ---------- occupancy delle celle con palle ------------------------
    (occupancy loc_2_3)
    (occupancy loc_3_3)
    (occupancy loc_4_3)
